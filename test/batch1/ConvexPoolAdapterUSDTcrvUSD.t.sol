...
contract ConvexPoolAdapterUSDTcrvUSDGenericTest is PRBTest, StdCheats {
     ...
     * default: WETH
     */
    address constant UNDERLYING_ASSET = 0xdAC17F958D2ee523a2206206994597C13D831ec7; // USDT
     ...
     */
    address public constant CURVE_POOL_ADDRESS = 0x390f3595bCa2Df7d23783dFd126427CCeb997BF4; // https://curve.fi/#/ethereum/pools/factory-v2-252/deposit

    /**
     * @dev Convex pool ID used in the integration.
     * default: ETH/msETH Curve pool PID
     */
    uint256 public constant CONVEX_PID = 179;
     ...
     */
    address constant ZAPPER = address(0); //0x08780fb7E580e492c1935bEe4fA5920b94AA95Da;

    uint256 forkBlockNumber;
    uint256 DEFAULT_FORK_BLOCK_NUMBER = 17_813_825;
    uint8 tokenDecimals;
