...
contract ConvexPoolAdapterETHOETHGenericTest is PRBTest, StdCheats {
     ...
     */
    address public constant CURVE_POOL_ADDRESS = 0x94B17476A93b3262d87B9a326965D1E91f9c13E7;

    /**
     * @dev Convex pool ID used in the integration.
     * default: ETH/msETH Curve pool PID
     */
    uint256 public constant CONVEX_PID = 174;

    /**
     * @dev Name of the strategy.
     */
    string public constant STRATEGY_NAME = "ETH/OETH Strat";
