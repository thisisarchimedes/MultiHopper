...
contract ConvexPoolAdapterETHLDOGenericTest is PRBTest, StdCheats {
     ...
     */
    address public constant CURVE_POOL_ADDRESS = 0x9409280DC1e6D33AB7A8C6EC03e5763FB61772B5;

    /**
     * @dev Convex pool ID used in the integration.
     * default: ETH/msETH Curve pool PID
     */
    uint256 public constant CONVEX_PID = 149;

    /**
     * @dev Name of the strategy.
     */
    string public constant STRATEGY_NAME = "ETH/LDO Strat";
