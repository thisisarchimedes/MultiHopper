...
contract ConvexPoolAdapteribEURUSDCGenericTest is PRBTest, StdCheats {
     ...
     */
    address public constant CURVE_POOL_ADDRESS = 0x1570af3dF649Fc74872c5B8F280A162a3bdD4EB6; // https://curve.fi/#/ethereum/pools/factory-v2-252/deposit

    /**
     * @dev Convex pool ID used in the integration.
     * default: ETH/msETH Curve pool PID
     */
    uint256 public constant CONVEX_PID = 86;

    /**
     * @dev Name of the strategy.
     */
    string public constant STRATEGY_NAME = "ibEUR/USDC Strat";
