...
contract ConvexPoolAdapterFRAXBPalUSDPGenericTest is PRBTest, StdCheats {
     ...
     */
    address public constant CURVE_POOL_ADDRESS = 0xc3b19502F8c02be75F3f77fd673503520DEB51dD; // https://curve.fi/#/ethereum/pools/factory-v2-147/deposit

    /**
     * @dev Convex pool ID used in the integration.
     * default: ETH/msETH Curve pool PID
     */
    uint256 public constant CONVEX_PID = 144;

    /**
     * @dev Name of the strategy.
     */
    string public constant SALT = "A231017";
    string public constant STRATEGY_NAME = "msUSD Guard"; 
    string public constant TOKEN_NAME = "psp.FRAXBP:msUSD";
    /**
